...
- **aggregation** — the full answer is spread over several chunks (a list).
...
python scripts/eval_retrieval.py --ef-search 200 # sweep HNSW recall/latency tradeoff
```

Metrics on 24 queries × 225 chunks are **directional, not statistically tight** — use
